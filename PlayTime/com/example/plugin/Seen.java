...
public class Seen extends JavaPlugin {
   ...
   protected void setup() {
      super.setup();
      Lang.init("en_us");
      this.getCommandRegistry().registerCommand(new SeenCommand("seen", "description", false));
      this.getCommandRegistry().registerCommand(new PlayTimeCommand("playtime", "description"));
