...
public class SaveConnect {
   public SaveConnect(@Nonnull PlayerRef playerRef, boolean connectOrDisconnect) {
      PlayerFileManager fileManager = new PlayerFileManager();
      JsonObject jsonObj = fileManager.getOrCreatePlayerFile(playerRef.getUsername());
      ...
      fileManager.savePlayerFile(playerRef.getUsername(), jsonObj);
   }
}
